...
class PingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getResponse = channel.unary_unary(
                '/com.epam.grpchometask.stubs.ping.PingService/getResponse',
...
def add_PingServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.epam.grpchometask.stubs.ping.PingService', rpc_method_handlers)
...
class PingService(object):
    ...
    def getResponse(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.epam.grpchometask.stubs.ping.PingService/getResponse',
